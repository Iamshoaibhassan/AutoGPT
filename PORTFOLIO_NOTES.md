# Portfolio study: AutoGPT

This repository is an attributed fork of [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT).
...
The upstream repository and its contributors retain authorship of upstream code. This fork preserves upstream license and copyright files. GitHub metadata reports: `NOASSERTION`. Review all nested dependencies and notices before redistribution. This profile does not claim authorship of upstream code.
